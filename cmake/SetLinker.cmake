...
# On Windows the linker is managed by the compiler toolchain (MSVC link.exe,
# MinGW ld, LLD, etc.) and does not need Unix-specific detection.
IF(WIN32)
  MESSAGE(STATUS "Linking with Windows toolchain default linker")
  RETURN()
ENDIF()
...
IF (CMAKE_LINKER_TYPE)
  ...
  IF ("${CMAKE_LINKER_TYPE}" STREQUAL "DEFAULT" OR "${CMAKE_LINKER_TYPE}" STREQUAL "SYSTEM")
    ...
    IF (GNU_LD_STRING MATCHES "^GNU ld")
      ...
      MESSAGE(STATUS "Linking with [ld] (${BoldBlue}v${GNU_LD_VERSION}${ColourReset})")
    ...
    ELSEIF (GNU_LD_STRING MATCHES "^mold")
      ...
      MESSAGE(STATUS "Linking with [mold] (${BoldBlue}v${GNU_MOLD_VERSION}${ColourReset})")
    ENDIF()
  # Use the LLVM linker
  ELSEIF("${CMAKE_LINKER_TYPE}" STREQUAL "LLD")
    ...
    MESSAGE(STATUS "Linking with [lld] (${BoldBlue}v${LLVM_LLD_VERSION}${ColourReset})")
  # Use the mold linker
